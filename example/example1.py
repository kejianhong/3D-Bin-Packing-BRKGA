...
def example1() -> None:
    ...
    brkga.fit(patient=5)
    stop_time = time.time()
    PrintPackingResult(brkga, filename=("example1_result", "example1_ems"))
    ...
    PlotGenerationProcess(brkga.fitness_mean_history, brkga.fitness_min_history, filename="example1_generation_process")
